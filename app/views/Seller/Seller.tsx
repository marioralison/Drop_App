import { View, Image, Text, TextInput, ScrollView, Pressable, Alert } from "react-native";
        ...
        <View className="w-full h-full bg-white p-[25] flex gap-10">
            ...
            <ScrollView className="w-full" showsVerticalScrollIndicator={false}>
                ...
                <View className="w-full gap-[25] mt-[50] mb-[20] text-xl font-lato-regular">
                    ...
                    <Pressable 
                        onPress={async () => {
                            const isSigned = await signupUser(users as IUser);
                            if (isSigned) router.push('/views/Seller/sellerDashboard')
                        }}
