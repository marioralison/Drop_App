    ...
    const renderVendeurItem = ({ item }: { item: IBestUser }) => (
        <View className="w-[150] h-full flex justify-between items-center">
            <ImageBackground 
                ...
                className="w-full h-[70%] flex flex-col justify-center items-center bg-zinc-100 rounded-xl">
            </ImageBackground>
            <View className="w-full h-[30%] mt-[8] flex justify-start items-start">
                <View className="w-full h-fit flex flex-row justify-between items-start">
